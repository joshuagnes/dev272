  ...
  return (
    <Box className="flex-1 p-4 dark:bg-zinc-800">
      <ScrollView className="flex-1 mb-20">
        ...
        <Box className="bg-white dark:bg-zinc-800 rounded-lg shadow-md p-6 mb-6 border border-gray-200">
          <Heading
            size="md"
            className="text-gray-700 dark:text-zinc-200 font-semibold mb-3"
          >
            Description:
          </Heading>
          ...
          <Text className="mb-3">{recipe.ingredients.join(", ")}</Text>
          ...
          <Text>
            Prep {recipe.time.prep} mins, Cook {recipe.time.cook} mins
          </Text>
