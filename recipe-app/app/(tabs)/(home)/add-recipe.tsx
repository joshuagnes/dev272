        ...
        <Formik
          ...
          onSubmit={(values, { resetForm, setErrors }) => {
            ...
            const recipeExists = recipes.some(
              (recipe) =>
                recipe.name.toLowerCase() === values.name.toLowerCase(),
            );
          ...
          {({
            ...
            <Box>
              ...
              <Box className="mb-4">
                ...
                <Textarea size="md" className="bg-white dark:bg-zinc-900 mt-2">
                  <TextareaInput
              ...
              >
                <ButtonText className="text-white">Add Recipe</ButtonText>
              </Button>
            </Box>
          )}
        </Formik>
